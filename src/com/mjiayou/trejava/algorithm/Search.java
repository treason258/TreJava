...
public class Search {
	...
	public static void main(String[] args) {
		...
		System.out.println("binarySearch -> " + binarySearch(mSortedData, 6));
		System.out.println("binarySearchRecursion -> " + binarySearchRecursion(mSortedData, 6));
	}
	...
	public static int binarySearchRecursion(int[] array, int key) {
		return binarySearchRecursion(array, 0, array.length - 1, key);
	}
